class Message < Communication
  ...
  validates_presence_of :subject, :content, :sender, :recipient
  ...
  after_create :save_recipient, :set_replied_to, :send_receipt_reminder, 
               :update_recipient_last_contacted_at
  ...
  private
    ...
    def send_receipt_reminder
      ...
      Notifier.deliver_message_notification(self) if @send_mail
    end
end