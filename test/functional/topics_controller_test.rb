...
class TopicsControllerTest < Test::Unit::TestCase
  ...
  def test_should_create_topic
    ...
    assert_redirected_to forum_topic_posts_path(:forum_id => 1, :topic_id => assigns(:topic))
  end
  ...
  def test_should_show_topic
    ...
    assert_redirected_to forum_topic_posts_path(:forum_id => 1, :topic_id => 1)
  end
  ...
  def test_should_destroy_topic
    ...
    assert_equal old_count-1, Topic.count    
    assert_redirected_to forum_topics_path(:forum_id => 1)
  end
end