...
class EntriesControllerTest < Test::Unit::TestCase
  ...
  def test_should_create_entry
    ...
    assert_redirected_to user_entry_path(:user_id => 1, :id => assigns(:entry))    
  end
  ...
  def test_should_update_entry
    ...
    assert_redirected_to user_entry_path(:user_id => 1, :id => 1)    
  end
  ...
  def test_should_destroy_entry
    ...
    assert_equal old_count-1, Entry.count    
    assert_redirected_to user_entries_path(:user_id => 1)
  end
end
